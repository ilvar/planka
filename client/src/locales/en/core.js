export default {
  ...
  translation: {
    common: {
      ...
      areYouSureYouWantToDeleteThisListCards:
        'Are you sure you want to delete all cards in this list?',
      ...
      deleteListCards_title: 'Delete Cards in List',
    ...
    action: {
      ...
      deleteList_title: 'Delete List',
      deleteListCards: 'Delete list cards',
      deleteListCards_title: 'Delete List Cards',
